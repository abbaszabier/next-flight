...
import FilterSeat from "./components/filterSeat";
import FilterFlight from "./components/filterFlight";
import FilterAirlanes from "./components/filterAirlanes";
import ListFlights from "./components/listFlights";
import LoadingFilterAirlanes from "./components/loadingFilterAirlanes";

export const metadata: Metadata = {
  title: "GoFlight | Available Flights",
};
      ...
      >
        <div className="flex w-full">
          <form className="ticket-filter flex flex-col shrink-0 w-[230px] gap-[30px] text-flysha-off-purple">
            <FilterSeat />
            <FilterFlight />
            <Suspense fallback={<LoadingFilterAirlanes />}>
              <FilterAirlanes />
            </Suspense>
          </form>
          <ListFlights />
